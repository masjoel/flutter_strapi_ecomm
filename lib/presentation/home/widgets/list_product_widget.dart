...
import 'package:flutter_strapi_ecomm/bloc/checkout/checkout_bloc.dart';
import 'package:flutter_strapi_ecomm/bloc/get_products/get_products_bloc.dart';
import 'package:flutter_strapi_ecomm/data/models/responses/list_product_response_model.dart';
import 'package:flutter_strapi_ecomm/presentation/detail_product/detail_product_page.dart';
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Rp.${formatAngka(product.attributes!.price!)}',
